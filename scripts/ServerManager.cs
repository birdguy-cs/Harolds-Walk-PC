...
public partial class ServerManager : Node
{
	...
	public Error JoinServer(string JoinID)
	{
		if (string.IsNullOrEmpty(JoinID))
        {
            JoinID = DefaultServerIP;
        }

        var peer = new ENetMultiplayerPeer();
        Error error = peer.CreateClient(JoinID, Port);
	...
	public Error MakeServer(int MaxClients)
	{
		var peer = new ENetMultiplayerPeer();
